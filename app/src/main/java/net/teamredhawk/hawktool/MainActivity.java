...
import net.teamredhawk.hawktool.Dialogs.About_dialog;
import net.teamredhawk.hawktool.Dialogs.ScriptDialog;
import net.teamredhawk.hawktool.RecyclerView.Adapter;
import net.teamredhawk.hawktool.RecyclerView.OnItemSelectedListener;
import net.teamredhawk.hawktool.Dialogs.InputDialog;
import net.teamredhawk.hawktool.UtilsHelper.FileHelper;
import net.teamredhawk.hawktool.UtilsHelper.PreferenceUtil;
import static net.teamredhawk.hawktool.UtilsHelper.FileHelper.*;
...
public class MainActivity extends AppCompatActivity {
    private static final String AUTORITHY= "net.teamredhawk.hawktool.provider";
    private static final String SAVED_DIRECTORY = "net.teamredhawk.hawktool.SAVED_DIRECTORY";
    private static final String SAVED_SELECTION = "net.teamredhawk.hawktool.SAVED_SELECTION";
    private static final String EXTRA_NAME = "net.teamredhawk.hawktool.EXTRA_NAME";
    private static final String EXTRA_TYPE = "net.teamredhawk.hawktool.EXTRA_TYPE";
    ...
    */
    ...
    private void gotoApplicationSettings() {
        ...
        intent.setData(Uri.fromParts("package", "net.teamredhawk.hawktool", null));
    ...
    private final class OnItemClickListener implements net.teamredhawk.hawktool.RecyclerView.OnItemClickListener {
