...
public class Adapter extends RecyclerView.Adapter<ViewHolder> {
    ...
    private final Respuesta callback;
    ...
    public Adapter(Context context) {
        ...
        this.callback = new Respuesta(context, this);
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(context).inflate(R.layout.explorer_layout, parent, false);
